...
var Controls = /** @class */ (function (_super) {
    ...
    Controls.prototype.render = function () {
        return (Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { className: styleControls, onClick: this.onClick, onDblClick: this.onDblClick, onMouseMove: !_utils__WEBPACK_IMPORTED_MODULE_4__["IS_TOUCHABLE_DEVICE"] && this.onMouseMove }, Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["renderPlugins"])(this.pluginName, this.props.plugins)));
    };
    Controls = __decorate([
...
var ToolBarProgressBar = /** @class */ (function (_super) {
    ...
    function ToolBarProgressBar(props) {
        ...
        _this.eventsMap = (_a = {},
            _a[_utils_event__WEBPACK_IMPORTED_MODULE_5__["NativeEvent"].Seeking] = function () {
                _this.setState({
                    seeking: true,
                });
            },
            _a[_utils_event__WEBPACK_IMPORTED_MODULE_5__["NativeEvent"].Seeked] = function () {
        ...
        _this.onTouchStart = function (e) {
            _this.handleSliderDown(e);
            _this.handleCursorDown(e);
        };
        _this.onTouchMove = function (e) {
            _this.handleCursorMove(e);
        };
        _this.onTouchEnd = function (e) {
            _this.handleCursorUp(e);
        };
        _this.onMouseDown = function (e) {
            if (e.target === _this.cursorEl) {
                _this.handleCursorDown(e);
            }
            else if (e.target === _this.sliderEl) {
                _this.handleSliderDown(e);
            }
        };
    ...
    ToolBarProgressBar.prototype.bindEvents = function () {
        for (var event_1 in this.eventsMap) {
            this.props.emitter.on(event_1, this.eventsMap[event_1]);
        }
    };
    ToolBarProgressBar.prototype.unbindEvents = function () {
    ...
    ToolBarProgressBar.prototype.render = function () {
        return (Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { className: styleProgressBar }, !this.state.isProgressBarHidden && (Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { className: styleProgressBarContent, onTouchStart: _utils__WEBPACK_IMPORTED_MODULE_3__["IS_TOUCHABLE_DEVICE"] && this.onTouchStart, onTouchMove: _utils__WEBPACK_IMPORTED_MODULE_3__["IS_TOUCHABLE_DEVICE"] && this.onTouchMove, onTouchEnd: _utils__WEBPACK_IMPORTED_MODULE_3__["IS_TOUCHABLE_DEVICE"] && this.onTouchEnd, onMouseDown: !_utils__WEBPACK_IMPORTED_MODULE_3__["IS_TOUCHABLE_DEVICE"] && this.onMouseDown, onMouseMove: !_utils__WEBPACK_IMPORTED_MODULE_3__["IS_TOUCHABLE_DEVICE"] && this.onMouseMove, onMouseUp: !_utils__WEBPACK_IMPORTED_MODULE_3__["IS_TOUCHABLE_DEVICE"] && this.onMouseUp },
    ...
    ToolBarProgressBar.prototype.getCursorLeft = function () {
        var _a = this.state, seeking = _a.seeking, cursorLeft = _a.cursorLeft;
        if (seeking) {
            return cursorLeft;
        }
        else {
            var _b = this.props.videoState, currentTime = _b.currentTime, duration = _b.duration;
            var percent = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["parsePercent"])((currentTime / duration) * 100);
            return percent;
        }
    };
    ToolBarProgressBar.prototype.handleSliderDown = function (e) {
        var offsetX;
        if (e instanceof MouseEvent) {
            offsetX = e.offsetX;
        }
        else {
            var elRect = this.sliderEl.getBoundingClientRect();
            offsetX = e.targetTouches[0].pageX - elRect.left;
        }
        var rate = offsetX / this.sliderEl.getBoundingClientRect().width;
        this.resetCursor(rate);
        console.log("handleSliderDown", rate);
        this.resetCurrentTime(rate);
    };
    ToolBarProgressBar.prototype.handleCursorDown = function (e) {
        this.setState({
            mouseOrigin: Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getMouseX"])(e),
            cursorOrigin: this.cursorEl.offsetLeft,
            isMouseDown: true,
        });
        this.props.emitter.emit(_utils_event__WEBPACK_IMPORTED_MODULE_5__["InnerEventType"].InnerProgressBarSeeking);
        this.setState({
            seeking: true,
        });
    };
    ToolBarProgressBar.prototype.handleCursorMove = function (e) {
        if (this.state.isMouseDown) {
            var mouseX = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getMouseX"])(e);
            var rate = this.caclulateOffsetX(mouseX);
            this.resetCursor(rate);
        }
    };
    ToolBarProgressBar.prototype.handleCursorUp = function (e) {
        if (this.state.isMouseDown) {
            var mouseX = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getMouseX"])(e);
            var rate = this.caclulateOffsetX(mouseX);
    ...
    ToolBarProgressBar.prototype.resetCurrentTime = function (rateUnparsed) {
        var rate = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["parseRate"])(rateUnparsed);
        var time = this.props.videoState.duration * rate;
        console.log("resetCurrentTime", time);
        this.props.emitter.emit(_utils_event__WEBPACK_IMPORTED_MODULE_5__["InnerEventType"].InnerVideoSetCurrentTime, time);
        this.props.emitter.emit(_utils_event__WEBPACK_IMPORTED_MODULE_5__["InnerEventType"].InnerProgressBarSeeked);
    };
    ToolBarProgressBar.prototype.resetCursor = function (rate) {
        var percent = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["parsePercent"])(rate * 100);
        this.setState({
            cursorLeft: percent,
        });
    };
    ToolBarProgressBar.prototype.caclulateOffsetX = function (eventX) {
        var progressBarWidth = this.sliderEl.getBoundingClientRect().width;
        var offsetX = eventX - this.state.mouseOrigin;
        offsetX += this.state.cursorOrigin;
        console.log("progressBarWidth", progressBarWidth, "eventX", eventX, "mouseOrigin", this.state.mouseOrigin, "cursorOrigin", this.state.cursorOrigin, "offsetX", offsetX, "offsetX / progressBarWidth", offsetX / progressBarWidth);
        if (offsetX < 0)
            offsetX = 0;
...
var ToolBar = /** @class */ (function (_super) {
    ...
    ToolBar.prototype.componentDidMount = function () {
        ...
        emitter.on(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerProgressBarSeeking, this.clearTimer);
        emitter.on(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerProgressBarSeeked, this.setTimer);
        this.hide();
    };
    ToolBar.prototype.componentWillUnmount = function () {
        ...
        emitter.off(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerProgressBarSeeking, this.clearTimer);
        emitter.off(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerProgressBarSeeked, this.setTimer);
    };
...
var actions = {
    ...
    setVideoInited: _utils_video__WEBPACK_IMPORTED_MODULE_2__["setVideoInited"],
...
var Player = /** @class */ (function (_super) {
    ...
    function Player() {
        ...
        _this.setCurrentTime = function () {
            _this.props.setCurrentTime(_this.el.currentTime);
        };
        return _this;
    }
    Player.prototype.componentDidMount = function () {
        var _this = this;
        var emitter = this.props.emitter;
        emitter.on(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerVideoPlay, function () { return _this.play(); });
        emitter.on(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerVideoPause, function () { return _this.pause(); });
        emitter.on(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerVideoToggle, function () { return _this.toggle(); });
        emitter.on(_utils_event__WEBPACK_IMPORTED_MODULE_4__["InnerEventType"].InnerVideoSetCurrentTime, function (e) { return _this.setNativeElementTime(e); });
        this.setCurrentTime = lodash_throttle__WEBPACK_IMPORTED_MODULE_5___default()(this.setCurrentTime, 1000);
    ...
    Player.prototype.setNativeElementTime = function (e) {
        if (this.el) {
...
(function (InnerEventType) {
    ...
    InnerEventType["InnerProgressBarSeeking"] = "inner.progressBarSeeking";
    InnerEventType["InnerProgressBarSeeked"] = "inner.progressBarSeeked";
...
/*!****************************!*\
  !*** ./src/utils/index.ts ***!
  \****************************/
/*! exports provided: canPlayTypeByFlash, IS_IOS, IS_SUPPORT_MSE, IS_SUPPORT_FLASH, IS_TOUCHABLE_DEVICE, initOptions, initState, parsePercent, parseRate, getTouchTarget, getMouseX */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseRate", function() { return parseRate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTouchTarget", function() { return getTouchTarget; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMouseX", function() { return getMouseX; });
...
/*!****************************!*\
  !*** ./src/utils/video.ts ***!
  \****************************/
/*! exports provided: setPlayState, setCurrentTime, setDuration, setVideoInited, setBuffered */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setVideoInited", function() { return setVideoInited; });
...
function setVideoInited(state, inited) {
    return Object(immer__WEBPACK_IMPORTED_MODULE_0__["default"])(state, function (draft) {
